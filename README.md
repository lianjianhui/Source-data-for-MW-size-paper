...
Here is a collection of the data presented in our paper on the radial structure and size of the Milky Way galaxy (Lian et al. 2024, https://ui.adsabs.harvard.edu/abs/2024NatAs...8.1302L/abstract). Six data files are included here, including the surface brightness profiles of the Milky Way and the sample of local galaxies with size measurements. Below is a description of the structure of each file.
